...
def prepare_data(args: argparse.Namespace, output_dir: Path) -> dict:
    ...
    summary = {
        "mind_train_dir": str(args.mind_train_dir),
        "telugu_dir": str(args.telugu_dir),
...
def main() -> None:
    ...
    args.mind_train_dir = resolve_path(repo_dir, args.mind_train_dir)
    args.telugu_dir = resolve_path(repo_dir, args.telugu_dir)
    args.output_dir = resolve_path(repo_dir, args.output_dir)
    if args.classifier_dir:
        args.classifier_dir = resolve_path(repo_dir, args.classifier_dir)
